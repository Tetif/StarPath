...
|---------|---------------------------|----------------|
| UI | http://localhost:5173 | http://localhost (nginx) or http://localhost:5173 |
| API | http://localhost:8000 | http://localhost:8000 |
| API docs | http://localhost:8000/docs | http://localhost:8000/docs |
| Health | http://localhost:8000/health | http://localhost/health or http://localhost:8000/health |
